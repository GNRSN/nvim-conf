...
local function setup(configs)
  ...
  return {
    ...
    LspFloatWinBorder = { fg = palette.fade },
    LspSagaHoverBorder = { fg = palette.fade },
    LspSagaSignatureHelpBorder = { fg = palette.fade },
    LspSagaCodeActionBorder = { fg = palette.fade },
    LspSagaDefPreviewBorder = { fg = palette.fade },
    LspLinesDiagBorder = { fg = palette.fade },
    LspSagaRenameBorder = { fg = palette.fade },
    LspSagaBorderTitle = { fg = palette.menu },
    LSPSagaDiagnosticTruncateLine = { fg = palette.fade },
    LspSagaDiagnosticBorder = { fg = palette.fade },
    LspSagaShTruncateLine = { fg = palette.fade },
    LspSagaDocTruncateLine = { fg = palette.fade },
    LspSagaLspFinderBorder = { fg = palette.fade },
